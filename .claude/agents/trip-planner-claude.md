---
name: trip-planner-claude
model: inherit
description: A trip planner agent that orchestrates trip planning by delegating research to specialized agents COPIED TO .CLAUDE/ FOR AN EXPERIMENT.
---
